      ...
      <div className="ml-72 mr-8 container mx-auto p-10">
        ...
        <div className="my-10">
          ...
          <div className="flex">
            ...
            />
            <button className="px-6 py-2 mt-2 font-medium tracking-wide text-white capitalize transition-colors text-sm duration-200 bg-blue-500 rounded-lg sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
              search
            </button>
          </div>
        </div>
        ...
        {/* start of scan table */}
        <div className="block mt-2 mr-5 w-full">
          ...
          <table className="mt-6 bg-white dark:bg-gray-800 min-w-full border divide-y dark:border-gray-700">
            ...
            {scans.map((scan) => (
              <tr key={scan.scan_id}>
                <td className="px-4 py-3 text-sm font-normal text-gray-900 dark:text-gray-50 whitespace-nowrap">
                  {scan.patient_name}
                </td>
                <td className="px-4 py-3 text-sm font-normal text-gray-900 dark:text-gray-50 whitespace-nowrap">
                  {scan.age}
