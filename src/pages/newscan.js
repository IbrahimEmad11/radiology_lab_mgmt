                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="mt-6 border-gray-300">
                                ...
                                <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        <label className="text-gray-700 dark:text-gray-200" htmlFor="scan_doctor">Doctor</label>
                                        <input name="scan_doctor" {...register("scan_doctor", { required: true })} id="scan_doctor" type="textarea" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"/>
                                    </div>

                                    <div>
                                        <label className="text-gray-700 dark:text-gray-200" htmlFor="scan_type">Scan Type</label>
                                        <input name="scan_type" {...register("scan_type", { required: true })} id="scan_type" type="textarea" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"/>
                                    </div>
