                ...
                <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                    ...
                    <form>
                        <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label for="Birthday" class="block text-sm text-gray-700 dark:text-gray-300">Birthday</label>
                            ...
                            <div>
                                <SelectSex className="text-gray-700 dark:text-gray-200" for="sex">Sex</SelectSex>
                            </div>
                            <div>
                    ...
                    <div className="mt-6 border-t border-gray-300">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                                <div>
                                    <label for="Birthday" class="block text-sm text-gray-700 dark:text-gray-300">Date</label>
                                    <input type="date" placeholder="John Doe" class="block  mt-2 w-full placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
                                </div>

                                <div>
                                    <DoctorMenu className="text-gray-700 dark:text-gray-200" for="doneBy">Done by</DoctorMenu>
                                </div>


                                <div>
                                    <ScanType className="text-gray-700 dark:text-gray-200" for="scanType">Scan type</ScanType>
                                </div>
                                <div>
                            ...
                            <div>
                                <label for="image" className=" text-gray-700 dark:text-gray-300">Scan</label>
